...
module.exports.execute = async (client, message, args) => {
  ...
  let secim = args[0];
  const embed = new MessageEmbed().setColor(client.randomColor()).setAuthor(message.member.displayName, message.author.avatarURL({ dynamic: true })).setFooter("Endless ❤️");
  if (secim == "liste") {
