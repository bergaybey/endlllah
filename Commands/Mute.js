...
module.exports.execute = async (client, message, args, ayar, emoji) => {
  let embed = new MessageEmbed().setAuthor(message.member.displayName, message.author.avatarURL({dynamic: true})).setFooter("Arox ❤️").setColor(client.randomColor()).setTimestamp();
...
module.exports.configuration = {
  name: "sınırsızmute",
  aliases: ['sınırsızsustur'],
  usage: "sınırsızmute [üye] [sebep]",
